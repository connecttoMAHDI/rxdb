...
import { sortObject, pluginMissing, overwriteGetterForCaching, clone, PROMISE_RESOLVE_FALSE, RXJS_SHARE_REPLAY_DEFAULTS, ensureNotFalsy, areRxDocumentArraysEqual, promiseWait } from "./plugins/utils/index.js";
...
import { getQueryMatcher, getSortComparator, normalizeMangoQuery, prepareQuery, runQueryUpdateFunction } from "./rx-query-helper.js";
...
export var RxQueryBase = /*#__PURE__*/function () {
  ...
  _proto.getPreparedQuery = function getPreparedQuery() {
    var hookInput = {
      ...
      mangoQuery: clone(this.normalizedQuery)
    };
...
;
  ...
  return _createClass(RxQueryBase, [{
    ...
    key: "normalizedQuery",
    get: function () {
      return overwriteGetterForCaching(this, 'normalizedQuery', normalizeMangoQuery(this.collection.schema.jsonSchema, this.mangoQuery, this.op === 'count'));
    }
    ...
    get: function () {
      ...
      return overwriteGetterForCaching(this, 'queryMatcher', getQueryMatcher(schema, this.normalizedQuery));
    }
  }, {
    key: "asRxQuery",
    get: function () {
...
export async function queryCollection(rxQuery) {
  ...
  if (rxQuery.isFindOneByIdQuery) {
    ...
    if (docs.length > 1) {
      ...
      var sortComparator = getSortComparator(collection.schema.jsonSchema, preparedQuery.query);
